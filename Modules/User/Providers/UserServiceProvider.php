...
use Modules\User\Repositories\Cache\CacheCompanyDecorator;
use Modules\User\Repositories\Cache\CacheUserDecorator;
use Modules\User\Repositories\Eloquent\EloquentCompanyRepository;
...
class UserServiceProvider extends ServiceProvider
{
    ...
    private function registerBindings()
    {
        ...
        $this->app->bind(
            'Modules\User\Repositories\CompanyRepository',
            function () {
                ...
                return new CacheCompanyDecorator($repository);
            }
        );
    }
